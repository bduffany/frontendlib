...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.request = function (url, _a) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var headers_, _i, _c, key, effectiveUrl, _d, _e, key, optionalBody, requestInfo, requestInit, response, responseContentType;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        if (query instanceof URLSearchParams) {
                            ...
                            for (_d = 0, _e = Object.keys(query); _d < _e.length; _d++) {
                                key = _e[_d];
