...
exports.validateJsonApiResponse = exports.jsonApiSchemaValidationMiddleware = void 0;
/**
 ...
 * @param next
 */
function jsonApiSchemaValidationMiddleware(_, res, next) {
...
exports.jsonApiSchemaValidationMiddleware = jsonApiSchemaValidationMiddleware;
/**
 * Validates API responses during development to ensure they adhere to a consistent
 * format.
 */
function validateJsonApiResponse(responseText) {
    var json;
    try {
...
exports.validateJsonApiResponse = validateJsonApiResponse;
